...
export const assignmentData: Record<string, Assignment> = {
  ...
  'A1': {
    ...
    flowchart: `graph TD
    A([Start]) --> B[/Accept year n/]
    B --> C{n % 4 == 0?}
    C -- No --> D[/Display Not Leap Year/]
    C -- Yes --> E{n % 100 == 0?}
    E -- No --> F[/Display Leap Year/]
    E -- Yes --> G{n % 400 == 0?}
    G -- No --> D
    G -- Yes --> F
    F --> H([Stop])
...
int main() {
  ...
  'A2': {
    ...
    flowchart: `graph TD
    A([Start]) --> B[/Accept operation op/]
    B --> C[/Accept numbers a and b/]
    C --> D{op == '+'}
    D -- Yes --> E[/Display a + b/]
    D -- No --> F{op == '-'}
    F -- Yes --> G[/Display a - b/]
...
int main() {
  ...
  'A4': {
    ...
    flowchart: `graph TD
    A([Start]) --> B[/Accept Basic Pay BP/]
    B --> C[Define HRA = 0.1, TA = 0.05, PT = 0.02]
    C --> D[GP = BP * 1 + HRA + TA]
    D --> E[TP = GP * 1 - PT]
    E --> F[/Display all information/]
    F --> G([Stop])`,
